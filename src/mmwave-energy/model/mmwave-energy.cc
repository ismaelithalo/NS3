...
{
    static TypeId tid =
        TypeId("ns3::MmWaveRadioEnergyModel")
...
void
MmWaveRadioEnergyModel::SetEnergyDepletionCallback(MmWaveRadioEnergyDepletionCallback callback)
{
    NS_LOG_FUNCTION(this);
    if (callback.IsNull())
    {
...
void
MmWaveRadioEnergyModel::SetEnergyRechargedCallback(MmWaveRadioEnergyRechargedCallback callback)
{
    NS_LOG_FUNCTION(this);
    if (callback.IsNull())
    {
