...
{
    static TypeId tid =
        TypeId("ns3::MmWaveRadioEnergyModelEnb")
...
void
MmWaveRadioEnergyModelEnb::SetEnergyDepletionCallback(MmWaveRadioEnergyDepletionCallback callback)
{
    NS_LOG_FUNCTION(this);
    if (callback.IsNull())
    {
...
void
MmWaveRadioEnergyModelEnb::SetEnergyRechargedCallback(MmWaveRadioEnergyRechargedCallback callback)
{
    NS_LOG_FUNCTION(this);
    if (callback.IsNull())
    {
